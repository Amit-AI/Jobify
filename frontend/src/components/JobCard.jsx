...
export default function JobCard({ jobPost }) {
    return (
        <Fragment>
            <div className="card w-full sm:max-w-3xl rounded-2xl border px-3 py-5 shadow-sm hover:shadow-md mb-4 cursor-pointer">
                {/* <!-- div-1 --> */}
                <div className="flex flex-col items-center sm:flex-row sm:items-center">
                    <img
                        className="w-20 rounded-full sm:mr-4 sm:h-16 sm:w-16"
                ...
                {/* <!-- div-4 --> */}
                <div className="dates mt-3 flex justify-between text-xs sm:text-sm">
